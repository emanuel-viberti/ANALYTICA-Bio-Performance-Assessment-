...
# 7. GUÍA DE MEDICIÓN (NUEVA SECCIÓN)
st.write("---")
st.subheader("📏 Guía: Cómo medir tu brazo")
st.write("""
1. **Punto de medición:** Medí en el punto medio entre el hombro (acromion) y el codo (olecranon).
2. **Contracción:** Flexioná el brazo a 90° y hacé fuerza máxima (bíceps contraído).
3. **Cinta:** La cinta debe estar firme pero sin apretar la piel. Tomá la medida en la parte más prominente del músculo.
""")
